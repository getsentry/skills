...
| `/Users/dcramer/.codex/skills/.system/skill-creator/SKILL.md` | local Codex upstream | secondary | 2026-03-05 | medium | Codex-native skill authoring conventions and structure | environment-local snapshot; may diverge from upstream | Used to align cross-agent portability expectations |
