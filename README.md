...
| [typing-exclusion-worker](plugins/sentry-skills/skills/typing-exclusion-worker/SKILL.md) | Remove assigned mypy exclusion modules in small scoped batches, fix typing issues, run validation, and produce a structured completion summary. |
