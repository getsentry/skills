...
- If the user names a skill, look for it under `.agents/skills/<name>/` first, then other established layouts such as `.claude/skills/<name>/`, `plugins/*/skills/<name>/`, or a repo-managed skill root with clear prior art
